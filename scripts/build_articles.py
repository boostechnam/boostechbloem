...
<meta property="og:image" content="{escape(schema.get('image', ORIGIN+'/assets/boostech-pure-performance-black.png'), quote=True)}"><meta name="twitter:card" content="summary_large_image">
...
for a in ARTICLES:
    ...
    share = f'<div class="article-share"><span>Share this article</span><a href="https://www.facebook.com/sharer/sharer.php?u={quote(url,safe="")}" target="_blank" rel="noopener noreferrer">Share on Facebook</a><a class="share-whatsapp" href="https://wa.me/?text={quote(a["title"]+chr(10)+url,safe="")}" target="_blank" rel="noopener noreferrer">Share on WhatsApp</a></div>'
