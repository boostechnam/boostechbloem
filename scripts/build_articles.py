...
for a in ARTICLES:
    ...
    message = quote('Hi Pieter, I read your article: '+a['title']+'. I would like advice about my vehicle.',safe='')
    cta = f'<section class="article-local-contact"><p class="eyebrow">BLOEMFONTEIN · FREE STATE</p><h2>Let’s talk about your vehicle.</h2><p>Send Pieter your vehicle’s year, make, model, engine, transmission and location. We’ll confirm compatibility, local availability and a quote for the work.</p><div class="article-contact-actions"><a class="button" href="https://wa.me/27739727708?text={message}" target="_blank" rel="noopener noreferrer">Ask Pieter on WhatsApp</a><a href="tel:+27739727708">+27 73 972 7708</a><a href="mailto:boostechbfn@gmail.com">boostechbfn@gmail.com</a></div></section>'
